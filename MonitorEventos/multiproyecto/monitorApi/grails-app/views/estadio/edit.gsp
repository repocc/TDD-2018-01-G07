...
<html>
    ...
    <body>
        ...
        <div id="edit-estadio" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.estadio}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.estadio}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.estadio}" method="PUT">
                <g:hiddenField name="version" value="${this.estadio?.version}" />
                <fieldset class="form">
                    <f:all bean="estadio"/>
                </fieldset>

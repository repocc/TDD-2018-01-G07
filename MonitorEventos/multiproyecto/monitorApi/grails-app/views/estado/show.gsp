...
<html>
    ...
    <body>
        ...
        <div id="show-estado" class="content scaffold-show" role="main">
            ...
            <f:display bean="estado" />
            <g:form resource="${this.estado}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.estado}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

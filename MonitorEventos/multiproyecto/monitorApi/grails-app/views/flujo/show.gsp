...
<html>
    ...
    <body>
        ...
        <div id="show-flujo" class="content scaffold-show" role="main">
            ...
            <f:display bean="flujo" />
            <g:form resource="${this.flujo}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.flujo}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

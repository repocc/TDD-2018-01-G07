...
class EstadoControllerSpec extends Specification {
    ...
    void "Test the index action returns the correct model"() {
        given:
        controller.estadoService = Mock(EstadoService) {
            1 * list(_) >> []
            1 * count() >> 0
        }
    ...
    void "Test the save action with an invalid instance"() {
        given:
        controller.estadoService = Mock(EstadoService) {
            1 * save(_ as Estado) >> { Estado estado ->
                throw new ValidationException("Invalid instance", estado.errors)
            }
        }
    ...
    void "Test the show action with a valid id"() {
        ...
        model.estado instanceof Estado
    }

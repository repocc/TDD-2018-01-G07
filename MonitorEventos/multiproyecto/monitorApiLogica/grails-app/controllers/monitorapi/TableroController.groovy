...
class TableroController {
        ...
        request.withFormat {
        	...
        	def agregarTablero(Tablero tablero) {
              ...
              switch(params.TiposDeConteo) {
                   ...
                   case       "Inicio": EdConteo = new ExtrategiaConteo('estadoInicio'); break;
                   case          "Fin": EdConteo = new ExtrategiaConteo('estadoFin'); break;
                   default:
                     tablero.errors.add "Tipo no valido"
                     respond tablero.errors, view:'edit'
                     return
    ...
    def mensajaNoDefinido (Tablero tablero){
      RecibirDato (tablero, params.mensaje)
    }

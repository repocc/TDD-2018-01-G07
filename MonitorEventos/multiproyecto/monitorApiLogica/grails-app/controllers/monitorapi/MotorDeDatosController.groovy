...
class MotorDeDatosController {
    ...
    def cambiarReglas(MotorDeDatos motorDeDatos) {
        if (motorDeDatos == null) {
            notFound()
            return
        }
        ...
        motorDeDatos.nuevasReglas('((define-counter "cambiosEstados" [] true)(define-counter "estadoFin" [] (current "fin")))(define-counter "estadoInicio" [] (current "inicio")))')
        motorDeDatos.moke++

...
<html>
    ...
    <body>
        ...
        <div id="show-estadio" class="content scaffold-show" role="main">
            ...
            <f:display bean="estadio" />
            <g:form resource="${this.estadio}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.estadio}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

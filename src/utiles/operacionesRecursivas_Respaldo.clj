(ns utiles.operacionesRecursivas
  ...
  (:require [clojure.core :refer :all]
			[definiciones.definiciones :refer :all]
...
(defmethod ejecutar_operacion :Funcion_Especial resolver_operaciones_especiales [coleccion estado_condicionado]
	...
	(let [ colec                 coleccion
          ...
          operador              (get diccionario_op_Func_especiales  (first colec))
...
(defmethod ejecutar_operacion :Funcion_Para_Strings resolver_operaciones_en_strings
  ;"Funciones requeridas para strings. Abarca: includes?, starts-with?, ends-with?"
   [coleccion estado_condicionado]
    ...
    ;(println "+++++++++++++++++++STRINGS+++++++++++++++++++++++")
	;(println "ESTO SE RECIBE COLECCIoN " colec)
	;(println "Esta es la funcion requerida Simbolica: " operador_symbol)
	;(println "El operador: " operador)
	;(println "primer_arg" primer_arg)
	;(println "segundo_arg" segundo_arg)
	;(println "todos_args_de_fn" todos_args_de_fn )
	;(println "++++++++++++++++++++++++++++++++++++++++++")
